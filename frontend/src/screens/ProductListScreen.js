...
function ProductListScreen({history}) {
    ...
    const {loading: create_loading, error: create_error, success: create_success, product: created_product} = productCreate
    ...
    }, [dispatch, history, userInfo, delete_success, create_success, created_product])
